      ...
      <div class="modal-container" @click.stop>
        <div class="modal-header">
          <div>
            ...
            <p class="modal-subtitle">{{ isEditing ? 'Atualize as informações do flashcard' : 'Preencha os dados abaixo' }}</p>
          </div>
        ...
        <form @submit.prevent="submitForm">
          <div class="modal-body">
            <div class="form-group">
              ...
              <textarea v-model="form.frente" class="form-textarea" rows="3" required placeholder="Digite a pergunta..."></textarea>
            </div>
            <div class="form-group">
              <label class="form-label">Resposta (Verso)</label>
              <textarea v-model="form.verso" class="form-textarea" rows="3" required placeholder="Digite a resposta..."></textarea>
            </div>
            <div class="form-group">
    ...
    <div v-if="showDeleteModal" class="modal-overlay" @click="showDeleteModal = false">
      <div class="modal-container confirm-modal" @click.stop>
        ...
        <div class="modal-body confirm-body">
          ...
          <p class="quiz-name">"{{ deletingFlashcard?.frente }}"</p>
...
const { flashcards, loading, loadFlashcards, createFlashcard, updateFlashcard, deleteFlashcard } = useFlashcards()
