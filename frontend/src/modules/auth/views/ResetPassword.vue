  ...
  <div class="reset-password-page">
    <div class="reset-password-card">
      <div class="reset-password-header">
        ...
        <p class="reset-password-subtitle">{{ $t('resetPassword.subtitle') }}</p>
      </div>
      ...
      <form @submit.prevent="handleSubmit">
        ...
        <div class="reset-password-form-actions">
          ...
          <button
            type="submit"
            class="btn-submit"
            :disabled="loading || form.senha.length < 6 || form.senha !== form.confirmar_senha"
          >
...
const { form, loading, showPassword, showConfirmPassword, handleSubmit } = useResetPassword()
</script>
