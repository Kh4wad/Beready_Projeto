  ...
  <div class="profile-edit-container">
    <div class="profile-edit-header">
      ...
      <div class="profile-edit-content">
        ...
        <div class="profile-edit-actions">
          <button class="btn-profile btn-secondary" @click="$router.push('/profile')">
            Voltar
          </button>
        </div>
      </div>
    ...
    <div class="profile-edit-body">
      <form @submit.prevent="handleSubmit">
          ...
          <div class="profile-edit-card">
            ...
            <div class="card-body">
              <div class="profile-edit-form-group">
                <label class="profile-edit-form-label">Nome Completo *</label>
                <input
                  v-model="form.nome"
                  type="text"
              ...
              <div class="profile-edit-form-group">
                <label class="profile-edit-form-label">E-mail *</label>
                <input
                  v-model="form.email"
                  type="email"
                  class="profile-edit-input-field"
        ...
        <div class="profile-edit-card profile-edit-mt-6">
          <div class="card-header">
            <div>
              <h3 class="card-title">
                <svg
...
const { form, loading, showPassword, showConfirmPassword, handleSubmit } = useProfileEdit()
</script>
